...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-navy">
    ...
    <div class="relative z-10 text-center px-4 sm:px-6 max-w-2xl mx-auto pt-24 pb-20">
        ...
        <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="#" class="inline-flex items-center gap-2 px-8 py-3.5 text-sm font-semibold text-white border-2 border-white/20 rounded-xl hover:bg-white/10 hover:border-white/40 transition-all duration-200">
                Notify Me
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
